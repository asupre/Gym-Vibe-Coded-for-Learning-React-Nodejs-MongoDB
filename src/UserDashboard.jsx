...
const UserDashboard = ({ user, onLogout }) => {
  ...
  const [userProfile, setUserProfile] = useState(user.profileImage || ''); // Local profile state
      ...
      <main className="flex-1 ml-64 p-12">
        ...
        {activeTab === 'dashboard' && (
          ...
          <div className="animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              ...
              <div className="group relative h-80 rounded-[40px] overflow-hidden border border-slate-800 opacity-50 shadow-2xl transition-all duration-500">

                <img src="https://images.unsplash.com/photo-1593095191071-82b0fdd67611?w=800" className="absolute inset-0 w-full h-full object-cover opacity-20" alt="Supplements" />

                <div className="absolute inset-0 bg-gradient-to-t from-slate-950 via-slate-950/20 to-transparent"></div>

                <div className="absolute bottom-8 left-8 right-8">

                  <h3 className="text-3xl font-black uppercase mb-2 text-slate-500 italic">Vault Shop</h3>

                  <p className="text-slate-500 text-sm mb-4 leading-relaxed italic text-wrap">Supplements management coming soon...</p>
        ...
        {activeTab === 'supplements' && (
          ...
          <div className="animate-in fade-in duration-500">
             ...
             <h2 className="text-4xl font-black mb-8 uppercase">Vault Supplements</h2>

             <p className="text-slate-500 italic">Supplement inventory management is coming soon.</p>

             <button onClick={() => setActiveTab('dashboard')} className="mt-6 text-orange-500 font-bold">← Back to Home</button>
